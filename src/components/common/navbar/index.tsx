...
import { Navbar as Nav, NavbarBrand, NavbarMenu, NavbarMenuToggle, NavbarMenuItem, NavbarItem } from "@nextui-org/react";
	...
	const userLinks = [
		{
			...
			url: storeUser.actualAccount ? `/${params.lang}/${storeUser.actualAccount?.account_key}/configuracion` : ''
		},
		{
