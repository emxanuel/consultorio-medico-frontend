...
export default function Navbar({ accessToken }: { accessToken: string }) {
	...
	const { setUser, user: storeUser, setHasViewedActivateAccount } = userStore()
	...
	useEffect(() => {
		if (actualAccount) {
			if (actualAccount.active === false) {
				setHasViewedActivateAccount(false)
			}
		}
	}, [actualAccount])
...
// 			url: storeUser.actualAccount ? `/${params.lang}/${storeUser.actualAccount?.account_key}/registro` : ''
// 		},
// 		{
// 			name: dictionary.consultations,
// 			url: storeUser.actualAccount ? `/${params.lang}/${storeUser.actualAccount?.account_key}/consultas` : ''
// 		},
// 		{
...
// 			url: storeUser.actualAccount ? `/${params.lang}/${storeUser.actualAccount?.account_key}/perfil` : ''
// 		}
// 	]
// 
// 	const userLinks = [
...
// 		},
// 		{
// 			name: dictionary.account_selection,
// 			url: '/seleccionar-cuenta'
// 		},
// 		{
	...
	return (
		<Nav className="w-screen bg-white bg-opacity-60" isMenuOpen={isMenuOpen} onMenuOpenChange={setIsMenuOpen}>
			...
			{/* <>
				...
				<Languages currentLang={params.lang as Locale}/>
			</>
			<>
